...
```{r ga_allws_nochn_es, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_nochn_es, limitDates = lim)  # or,
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_1, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "(Other)"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_2, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "Direct"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_3, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "Display"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_4, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "Email"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_5, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "Organic Search"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_6, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "Paid Search"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_7, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "Referral"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
...
```{r ga_allws_chn_es_8, echo=FALSE, fig.width=10}
gadata <- completeGADates(ga_allws_chn_es[Channel == "Social"], limitDates = lim)
plotsGA <- getPlotGAList(gadata)
